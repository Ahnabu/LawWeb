      ...
      <section className="bg-primary px-6 py-20 text-white sm:px-8 lg:px-10">
        <div className="mx-auto max-w-6xl">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-secondary">
            About Islam & Associates
          </p>
          <h1 className="mt-4 font-display text-5xl font-bold leading-tight">
            A Legacy of Legal Excellence in Bangladesh
          </h1>
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
            We believe in honest, sincere and fast remedies for our clients and
            believe in growth with our clients&apos; successes.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="card-elevated space-y-6 p-10">
            ...
            <p className="text-base leading-7 text-on-surface-variant">
              Islam & Associates is an elite law firm serving Dhaka and global
              clients with deep expertise across corporate, civil, criminal,
              immigration, and family law. Our commitment is to deliver
              transparent, ethical, and rapid legal solutions.
            </p>
            <div className="rounded-xl bg-secondary/10 p-8">
              ...
              <p className="mt-4 text-lg font-semibold leading-7 text-on-surface">
                We believe in honest, sincere and fast remedies for our clients
                and believe in growth with our clients&apos; successes.
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="card-elevated p-10">
            ...
            <p className="mt-4 text-lg font-semibold text-on-surface">
              Mufassil MM Islam — LL.B (Hons) & LL.M, Dhaka University
            </p>
            <p className="mt-3 leading-7 text-on-surface-variant">
              Principal counsel with decades of litigation and international
              compliance experience. Trusted by local and global clients to
              navigate complex law with clarity.
            </p>
            <div className="mt-8 space-y-4">
              {[
                "Harvard University (Internet Law)",
                "Central Law Training England",
                "Kensington University USA",
                "Neil Weinrib PC USA",
                "Ashley Bean & Co. Solicitors England",
              ].map((credential) => (
                <p
                  key={credential}
              ...
              {["Integrity", "Expertise", "Client Success"].map((value) => (
                ...
                >
                  ...
                  <p className="mt-2 text-on-surface-variant">
                    Committed to maintaining the highest standards in every
                    legal engagement, always acting with honesty and
                    transparency.
                  </p>
                </div>
              ))}
