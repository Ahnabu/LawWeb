...
const translationBundle = {
  en: {
    ...
    trackCase: {
      ...
      subtitle:
        "Enter your Case ID (e.g. CAS-2025-001) and the email address used when filing to view the latest status.",
      placeholder: "Case ID (e.g. CAS-2025-001)",
      emailPlaceholder: "Email address on the case",
      trackNow: "Track Now",
      searching: "Searching...",
      notFound:
        "No case matches that Case ID and email. Please check your details or",
      ...
      emptyHint: "Enter your Case ID and email above to check your case status.",
  ...
  bn: {
    ...
    trackCase: {
      ...
      subtitle:
        "সর্বশেষ অবস্থা দেখতে আপনার কেস আইডি (যেমন CAS-2025-001) এবং মামলা দায়েরের সময় ব্যবহৃত ইমেল ঠিকানা লিখুন।",
      placeholder: "কেস আইডি (যেমন CAS-2025-001)",
      emailPlaceholder: "মামলায় ব্যবহৃত ইমেল ঠিকানা",
      trackNow: "এখন ট্র্যাক করুন",
      searching: "অনুসন্ধান করা হচ্ছে...",
      notFound:
        "এই কেস আইডি ও ইমেলের সাথে মিলে এমন কোনো মামলা পাওয়া যায়নি। অনুগ্রহ করে আপনার তথ্য যাচাই করুন অথবা",
      ...
      emptyHint: "আপনার মামলার অবস্থা দেখতে উপরে কেস আইডি ও ইমেল লিখুন।",
